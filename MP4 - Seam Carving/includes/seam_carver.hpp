...
public:
  ...
  void FindMinEnergy(int left, int middle, int right, int& min_energy, int& min_dir) const;

  void ComputeVerticalEnergySums(int** energy_sums) const;

  void ComputeHorizontalEnergySums(int** energy_sums) const;

  int FindMinIndexInLastRow(int** energy_sums) const;

  int* TraceVerticalSeam(int** energy_sums, int min_col) const;

  int* TraceHorizontalSeam(int** energy_sums, int min_row) const;

  int FindMinIndexInLastColumn(int** energy_sums) const;
